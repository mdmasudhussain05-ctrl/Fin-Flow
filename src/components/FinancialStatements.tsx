...
const FinancialStatements = () => {
  ...
  const renderNotAvailableMessage = () => (
    <div className="text-center py-12 text-gray-600 dark:text-gray-400">
      ...
      <p className="mb-1">Financial statements for {periodLabel} will be available after the period has fully closed.</p>
  ...
  return (
    <Card className="glass-effect">
      ...
      <CardContent>
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-6"> {/* Added mb-6 for spacing below controls */}
        ...
        {!available ? (
          ...
          <Tabs defaultValue="profit-loss" className="w-full">
            ...
            <TabsContent value="profit-loss" className="mt-6"> {/* Added mt-6 for spacing above content */}
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-2xl font-bold text-green-600 mb-4">{baseCurrency} {profitLossAccount.totalIncome.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p> {/* Added mb-4 */}
                        <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300"> {/* Changed space-y-1 to space-y-2 */}
                          {profitLossAccount.incomeBreakdown.map((item, index) => (
                            <li key={index} className="flex justify-between py-1"> {/* Added py-1 for vertical padding */}
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-2xl font-bold text-red-600 mb-4">{baseCurrency} {profitLossAccount.totalExpenses.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p> {/* Added mb-4 */}
                        <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300"> {/* Changed space-y-1 to space-y-2 */}
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className={`text-3xl font-bold ${profitLossAccount.netProfitLoss >= 0 ? 'text-green-700' : 'text-red-700'} mb-2`}> {/* Added mb-2 */}
            ...
            <TabsContent value="balance-sheet" className="mt-6"> {/* Added mt-6 for spacing above content */}
              ...
              {balanceSheet ? (
                <div className="space-y-6">
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-2xl font-bold text-blue-600 mb-4">{baseCurrency} {balanceSheet.totalAssets.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p> {/* Added mb-4 */}
                      <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300"> {/* Changed space-y-1 to space-y-2 */}
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-2xl font-bold text-orange-600 mb-4">{baseCurrency} {balanceSheet.totalLiabilities.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p> {/* Added mb-4 */}
                      <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300"> {/* Changed space-y-1 to space-y-2 */}
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-3xl font-bold text-purple-600 mb-2"> {/* Added mb-2 */}
            ...
            <TabsContent value="journal-entries" className="mt-6"> {/* Added mt-6 for spacing above content */}
            ...
            <TabsContent value="ledger-accounts" className="mt-6"> {/* Added mt-6 for spacing above content */}
